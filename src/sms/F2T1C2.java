 ...
 * @author benson
 */
public class F2T1C2 extends javax.swing.JFrame {
        ...
        try {
            ...
            */
            try {
                ...
                java.util.logging.Logger.getLogger(F2T1C2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new F2T1C2().setVisible(true);
                }
            });
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(F2T1C2.class.getName()).log(Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            Logger.getLogger(F2T1C2.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            Logger.getLogger(F2T1C2.class.getName()).log(Level.SEVERE, null, ex);

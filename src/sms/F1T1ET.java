 ...
 * @author benson
 */
public class F1T1ET extends javax.swing.JFrame {
        ...
        try {
            ...
            */
            try {
                ...
                java.util.logging.Logger.getLogger(F1T1ET.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new F1T1ET().setVisible(true);
                }
            });
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(F1T1ET.class.getName()).log(Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            Logger.getLogger(F1T1ET.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            Logger.getLogger(F1T1ET.class.getName()).log(Level.SEVERE, null, ex);

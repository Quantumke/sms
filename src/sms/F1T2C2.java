...
public class F1T2C2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(F1T2C2.class.getResource("ic_school_black_24dp.png")));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            */
            ...
            Logger.getLogger(F1T2C2.class.getName()).log(Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            Logger.getLogger(F1T2C2.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            Logger.getLogger(F1T2C2.class.getName()).log(Level.SEVERE, null, ex);

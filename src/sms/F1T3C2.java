 ...
 * @author benson
 */
public class F1T3C2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(F1T3C1.class.getResource("ic_school_black_24dp.png")));
        ...
        try {
            ...
            */
            try {
                ...
                java.util.logging.Logger.getLogger(F1T3C2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new F1T3C2().setVisible(true);
                }
            });
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(F1T3C2.class.getName()).log(Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            Logger.getLogger(F1T3C2.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            Logger.getLogger(F1T3C2.class.getName()).log(Level.SEVERE, null, ex);
